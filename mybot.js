...
client.on('message', (message) => {
  ...
  if (content === 'a suprise to be sure, but a welcome one.') {
    message.channel.send(`https://i.redd.it/3ah6k9okldoy.jpg`)
  }
  if (content === 'visible confusion') {
...
// token lul
client.login('NDc1MTU0MDMxMTk5NzgwODg0.Dka5Ww.y0jO4iySBWWag-It6uYmcn2NbbQ')
